...
<svelte:head>
	<title>Home</title>
	<meta name="description" content="Camgo homepage" />
</svelte:head>
...
>
	<div class="hero min-h-screen bg-base-200 bg-opacity-85">
		<div class="hero-content text-center">
			<div class="max-w-l">
				...
				<div class="card bg-base-100 shadow-xl max-w-s mx-auto mb-8">
				...
				<a class="btn btn-primary btn-lg" href="{base}/join">Start Your Camouflage Adventure</a>
			</div>
		</div>
	</div>
</main>
